...
# Affichage du reste de l'application ici
st.markdown("""
---

⬇️ Vous pouvez maintenant sélectionner les matériaux et entrer les paramètres pour calculer la charge calorifique et générer les courbes.
